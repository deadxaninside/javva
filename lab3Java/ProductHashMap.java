...
class Product {
    ...
    public Product(String name, String description, int quantity, double price) {
        this.name = name; //инициализируем
        this.description = description;
        this.quantity = quantity;
        this.price = price;
    }
//переопределяем метод toString() для вывода о товаре
    @Override
...
public class ProductHashMap {
    private HashMap<String, Product> productMap; //поле для хранения товаров

    public ProductHashMap() {
        productMap = new HashMap<>();
    } //инициализируем пустую хэш-таблицу
